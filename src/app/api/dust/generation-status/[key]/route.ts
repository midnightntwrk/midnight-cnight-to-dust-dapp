...
export async function GET(request: NextRequest, { params }: { params: Promise<{ key: string }> }) {
    ...
    try {
        ...
        if (!rewardAddress) {
            ...
            return NextResponse.json({ error: 'Reward address is required' }, { status: 400 });
        }
        ...
        try {
            ...
            return NextResponse.json({ error: 'Indexer endpoint configuration is invalid' }, { status: 500 });
        }
