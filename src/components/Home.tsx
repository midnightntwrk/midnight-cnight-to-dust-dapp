    ...
    return (
        <div className="flex flex-col items-center justify-center h-full gap-[40px]">
            ...
            <div className="flex flex-col items-center justify-center text-center px-4">
                <p className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-bold leading-tight">Start generating private DUST</p>
                <p className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-bold leading-tight">from your cNIGHT holdings</p>
            </div>
