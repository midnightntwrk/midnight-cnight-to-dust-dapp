            ...
            <div className="flex items-start gap-3">
                ...
                <div className="flex-1">
                    ...
                    <p className="text-amber-100/80 text-sm leading-relaxed">
                        Your registration was successful and recorded on the Cardano blockchain.
                        The indexer is processing your registration, which may take up to <span className="font-semibold text-amber-200">12 hours</span>.
                        Once complete, your DUST generation details will appear below.
                    </p>
                </div>
            </div>
        </Card>
