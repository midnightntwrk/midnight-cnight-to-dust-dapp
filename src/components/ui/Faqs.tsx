    ...
    const faqData = [
        {
            key: "1",
            title: "What is DUST?",
            content: "You will need DUST token to pay gas in Midnight. DUST is a unique token that plays a crucial role in our ecosystem, enhancing transaction efficiency and user engagement."
        },
        {
            key: "2", 
